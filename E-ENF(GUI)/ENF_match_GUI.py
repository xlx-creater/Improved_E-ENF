...
from DV_data import block_sampling
...
def start_program_button():
    ...
    Use_data = block_sampling(file_path, ConstFs)   #Temporal and Spatital Sampling


    k = 4     # Harmonic order
    TH = 0.015     # Deviation threshold
    Freq_bounds = 0.2  # Frequency fluctuation range
    IFtest1 = Fine_tuning(Use_data, k, AWindowLength, AStepSize, ConstFs, NFFT, TH, Freq_bounds) #Harmonic-based Fine-tuning
